                ...
                <div class="card-body">
                    <form action="{{ route('admin.documents.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="document">@lang('Tài liệu') <small class="text-danger">(@lang('PDF, Word, Excel, PowerPoint, Image, ZIP, RAR tối đa 10MB'))</small></label>
                                    <input type="file" name="document" class="form-control" required accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.zip,.rar,.jpg,.jpeg,.png">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex flex-wrap gap-3 mt-2">
                                        <div class="custom-control custom-checkbox form-check">
                                            <input type="checkbox" name="for_manager" id="for_manager" value="1" class="custom-control-input" checked>
                                            <label class="custom-control-label" for="for_manager">@lang('Quản lý')</label>
                                        </div>
                                        <div class="custom-control custom-checkbox form-check">
                                            <input type="checkbox" name="for_staff" id="for_staff" value="1" class="custom-control-input" checked>
