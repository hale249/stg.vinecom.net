        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-7 text-center">
                    ...
                    <span class="star-glow glow-1"
                        style="background: url({{ asset('assets/errors/images/star-glow.png') }}) no-repeat center"></span>
                    <span class="star-glow glow-2"
                        style="background: url({{ asset('assets/errors/images/star-glow.png') }}) no-repeat center"></span>
                    <span class="star-glow glow-3"
                        style="background: url({{ asset('assets/errors/images/star-glow.png') }}) no-repeat center"></span>
                    <span class="star-glow glow-4"
                        style="background: url({{ asset('assets/errors/images/star-glow.png') }}) no-repeat center"></span>
