            ...
            <div class="card custom--card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('invest.contract', $invest->id) }}" class="btn btn-sm btn-outline--primary">
                                <i class="las la-arrow-left"></i> @lang('Back to Contract')
                            </a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <strong>@lang('Project'):</strong> {{ $invest->project->title }}
                            </div>
                            <div>
                                                ...
                                                <tbody>
                                                    @foreach($signedContracts as $document)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    <a href="{{ route('user.invest.documents.download', [$invest->id, $document->id]) }}" class="btn btn-sm btn--success">
...
<div class="modal fade" id="uploadModal" tabindex="-1" aria-labelledby="uploadModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('user.invest.documents.upload', $invest->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
...
<script>
    (function($) {
        ...
        $('.delete-btn').on('click', function() {
            ...
            $('#deleteForm').attr('action', "{{ route('user.invest.documents.delete', [$invest->id, '']) }}/" + documentId);
