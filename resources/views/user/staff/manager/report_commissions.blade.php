            ...
            <div class="card-body p-0">
                            ...
                            <tbody>
                                @foreach($commissions as $key => $item)
                                    <tr>
                                        ...
                                        <td>{{ showAmount($item->commission_amount) }} {{ $general->cur_text }}</td>
                                        <td>{{ showDateTime($item->commission_date) }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                ...
                @else
                    <div class="empty-state text-center py-5">
                        ...
                        <p class="text-muted">@lang('Không có dữ liệu hoa hồng.')</p>
                    </div>
                @endif
            </div>
        </div>
