            ...
            $('.notice').append(`
                <div class="notification-alert">
                    <div class="notification-icon">
                        <i class="las la-bell text--danger"></i>
                    </div>
                    <div class="notification-content">
                        <h6>@lang('Please Allow / Reset Browser Notification')</h6>
                        <p>@lang('If you want to get push notification then you have to allow notification from your browser')</p>
                    </div>
                </div>
            `);
        }
